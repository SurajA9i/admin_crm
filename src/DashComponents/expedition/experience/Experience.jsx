...
import { getExperience, updateExpeditions, deleteExperience } from '../../../../services/ExpeditionsApi';
                    ...
                    <Row className="mb-0 align-items-center">
                        ...
                        <Col className="text-end">
                            <Button
                                ...
                                variant="success"
                                onClick={() => {
                                    navigate('/expeditions/wildlife-experience/add-experience');
                                }}
                            >
                                Add Experience
                            </Button>
                                        ...
                                        <tr key={item._id}>
                                            ...
                                            <td>
                                                <Button
                                                    ...
                                                    size="sm"
                                                    className="me-2"
                                                    onClick={() => navigate(`/expeditions/wildlife-experience/edit-experience/${item._id}`)}
                                                >
                                                    Edit
                                                </Button>
