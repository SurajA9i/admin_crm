...
import { updateAttraction, getAttractionById } from "../../../../services/ExpeditionsApi";
...
const EditAttraction = () => {
    ...
    const onSubmit = async (values, { setSubmitting, resetForm }) => {
        try {
            ...
            const response = await updateAttraction(id, formData);

            if (response?.status) {
                showSuccessToast("Attraction Updated Successfully");
