...
import { DestinationCreate } from '../../../services/DestinationApi';
import ReactQuill from 'react-quill';
import { showSuccessToast, showFailureToast } from '../toastsAlert/Alert.jsx';

const AddDestination = ({ show, handleClose, getData }) => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const res = await DestinationCreate(formData);
      if (res?.status) {
        getData();
      ...
      showFailureToast('Failed To Add Destination');
    }
  };
